...
```{r fig.width = 12, fig.height = 12}
create_cleveland_plot_1 <- function(rating_matrix, genres, n, our_user) {
...
p1 <- create_cleveland_plot_1(rating_matrix, genres, 20, 5)
p2 <- create_cleveland_plot_1(rating_matrix, genres, 20, 25)
p3 <- create_cleveland_plot_1(rating_matrix, genres, 20, 50)
p4 <- create_cleveland_plot_1(rating_matrix, genres, 20, 150)
...
show_cleveland_grid <- function(user) {
  p1 <- create_cleveland_plot_1(rating_matrix, genres, 20, user)
  p2 <- create_cleveland_plot_1(rating_matrix, genres, 30, user)
  p3 <- create_cleveland_plot_1(rating_matrix, genres, 40, user)
  p4 <- create_cleveland_plot_1(rating_matrix, genres, 50, user)
