...
```
Es fällt auf, dass sehr hohe Ähnlichkeiten sehr selten vorkommen. Ebenfalls auffällig ist, dass es eine Spitze bei Ähnlichkeiten von 0 gibt. Dieser Peak stellt also Filme welche überhaubt nicht zu einem Nutzer passen und demnach eine Cosine-Similarity von 0 besitzen dar. Auf diesem Diagramm ist es nicht sehr deutlich zu sehen, dass all diese Werte tatsächlich 0 sind, doch genau dies ist bei genauerem Betrachten der Daten aufgefallen. Ansonsten sind die Ähnlichkeiten relativ gleichmässig verteilt. Wobei am meisten Ähnlichkeiten um ca. 0.4 liegen.
...
```
In dieser Matrix wird en sogenannter negativabzug erstellt. Das bedeutet alle einträge welche eine Bewertung eines Users für einen Film darstellen werden zu einer '0', wobei alle NA werte, welche nicht bewertete Filme pro User darstellen, zu einer '1'.
